...
(function (factory) {
  ...
  function SaveDatasetButton() {
    ...
    const [modalOpen, setModalOpen] = useState$3(false);
    const [sending, setSending] = useState$3(false);
    const [errorText, setErrorText] = useState$3("");
  ...
  const createContext$1 = window["React"].createContext;
  ...
  const ErrorContext = createContext$1(null);
  ...
  const useErrorModal = () => {
    const context = useContext$1(ErrorContext);
    if (context === void 0) {
  ...
  const Alert = window["__mui__"].Alert;
  const Snackbar = window["__mui__"].Snackbar;
  ...
  const AlertSnackbarProvider = (props) => {
    ...
    return /* @__PURE__ */ jsxs(AlertSnackbarContext.Provider, {
      value: {
        setAlertText,
        setOpen
      },
      ...props,
      children: [props.children, alertText && /* @__PURE__ */ jsx(AlertSnackbar, {
        alertText,
        open,
        setOpen
      })]
            ...
            children: [/* @__PURE__ */ jsxs(TooltipDiv, {
              ...
              children: [/* @__PURE__ */ jsx(Grid, {
                ...
                children: /* @__PURE__ */ jsx(Autocomplete, {
                  options: editableFields.current,
  ...
  function Plugin() {
    ...
    return /* @__PURE__ */ jsx(Fragment, {
      children: /* @__PURE__ */ jsx(ErrorModalProvider, {
        children: /* @__PURE__ */ jsx(AlertSnackbarProvider, {
