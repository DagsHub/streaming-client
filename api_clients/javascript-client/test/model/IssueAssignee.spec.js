...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('IssueAssignee', function() {
      beforeEach(function() {
        instance = new DagsHubApi.IssueAssignee();
      });

      it('should create an instance of IssueAssignee', function() {
        // TODO: update the code to test IssueAssignee
        expect(instance).to.be.a(DagsHubApi.IssueAssignee);
      });
