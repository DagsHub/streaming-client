...
namespace IO.Swagger.Model
{
        ...
        public partial class WebhookEvents : List<Object>,  IEquatable<WebhookEvents>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as WebhookEvents);
        }

        /// <summary>
        /// Returns true if WebhookEvents instances are equal
        /// </summary>
        /// <param name="input">Instance of WebhookEvents to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebhookEvents input)
        {
            if (input == null)
                return false;
